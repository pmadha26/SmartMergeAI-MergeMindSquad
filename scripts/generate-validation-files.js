...
class ValidationFilesGenerator {
  ...
  async generateTestRequirementsFile() {
    ...
    content += `---\n*Generated by SmartMergeAI - Validation Files Generator*\n`;
  ...
  async generateReadmeFile() {
    ...
    content += `## Overview\n\n`;
    content += `This directory contains validation files generated by SmartMergeAI to assist with PR review.\n\n`;
